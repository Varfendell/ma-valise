...
class ProjectType extends AbstractType
{
	...
	{
		$builder->add('name', TextType::class, ['label' => 'Quel est le nom de ton projet?'])->add('dateStart', DateType::class, ['label' => 'Quand souhaites-tu partir?', 'input_format' => 'd-m-Y'],)->add('dateEnd', DateType::class, ['label' => 'Quand souhaites-tu revenir?', 'input_format' => 'd-m-Y'])->add('description')->add('cagnotte', EntityType::class, ['class' => Cagnotte::class, 'choice_label' => function (Cagnotte $cagnotte) {
