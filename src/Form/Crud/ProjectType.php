...
class ProjectType extends AbstractType
{
	...
	{
		$builder->add('lala', TextType::class)->add('dateStart')->add('dateEnd')->add('description')->add('cagnotte', EntityType::class, ['class' => Cagnotte::class, 'choice_label' => function (Cagnotte $cagnotte) {
