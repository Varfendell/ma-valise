...
class ProjectType extends AbstractType
{
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		$builder->add('name', TextType::class)->add('desires', ChoiceType::class, ['required' => false, 'choices' => [
            ...
            'expanded' => true,
            'multiple' => true])->add('dateStart', DateType::class, ['widget' => 'single_text', 'format' => 'dd-MM-yyyy'])->add('dateEnd', DateType::class)->add('who', ChoiceType::class, ['required' => true, 'choices' => [
                'Seul(e)' => false,
            'En couple' => false,
            'En famille' => false,
            'Entre amis' => false],
